...
#include "mvtkGeometryTypes.h"

/// mvtkMesh - an abstract class for mesh types
///////////////////////////////////////////////////////////////////////////
/// mvtkMesh is an abstract class for mesh types which are used to represent
/// 3D objects with their surfaces.
/// \see mvtkTriangleMesh
/// \see mvtkHEMesh
/// \see mvtkHETriangleMesh
class MVTK_COMMON_API mvtkMesh : public mvtkDataObject
{
public:
	MVTK_ABSTRACT_TYPE(mvtkMesh, mvtkDataObject)
	...
	///////////////////////////////////////////////////////////////////////////
	/// Shallowcopy.
	/// \param src pointer to the source mvtkDataObject
	///////////////////////////////////////////////////////////////////////////
	virtual void ShallowCopy(mvtkDataObject *src);

	///////////////////////////////////////////////////////////////////////////
	/// Deep copy.
	/// \param src pointer to the source mvtkDataObject
	///////////////////////////////////////////////////////////////////////////
	virtual void DeepCopy(mvtkDataObject *src);
	...
	/// \note The template struct _face_type is defined as follows in mvtkGeometryTypes.h:
	/// \code
...
private:
	mvtkMesh(const mvtkMesh&);
	void operator = (const mvtkMesh&);

};

inline void mvtkMesh::GetBoundingBox(float &minX, float &maxX, float &minY, float &maxY, float &minZ, float &maxZ)
{
...
inline void mvtkMesh::GetBoundingBox(float bounds[6])
{ this->GetBoundingBox(bounds[0], bounds[1], bounds[2], bounds[3], bounds[4], bounds[5]); }

inline void mvtkMesh::SetBoundingBox(float minX, float maxX, float minY, float maxY, float minZ, float maxZ)
{
...
inline void mvtkMesh::SetBoundingBox(float bounds[6])
{ this->SetBoundingBox(bounds[0], bounds[1], bounds[2], bounds[3], bounds[4], bounds[5]); }


//#define DEFINED_mvtkMesh
