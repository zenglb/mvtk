...
mvtkMatrix4x4::mvtkMatrix4x4() 
{
	IdentityMatrix();
}
mvtkMatrix4x4::mvtkMatrix4x4(const mvtkMatrix4x4 &m)
{
	ele[0] =  m.ele[0]; 
	ele[1] =  m.ele[1]; 
	ele[2] =  m.ele[2]; 
...
mvtkMatrix4x4::mvtkMatrix4x4(float e0, float e1, float e2, float e3,
...
mvtkMatrix4x4 mvtkMatrix4x4::TranslateMatrix(float tx,float ty,float tz)
{
	mvtkMatrix4x4 tMat;
	tMat[12]=tx; tMat[13]=ty; tMat[14]=tz;
	return tMat;
}
mvtkMatrix4x4 mvtkMatrix4x4::ScaleMatrix(float sx,float sy,float sz)
{
	mvtkMatrix4x4 sMat;
	sMat[0]=sx; sMat[5]=sy; sMat[10]=sz;
	return sMat;
}
mvtkMatrix4x4 mvtkMatrix4x4::RotateMatrix(float angle,float x,float y,float z)
{
	mvtkQuaternion q(x,y,z,angle);
	return q.ToMatrix();
}
