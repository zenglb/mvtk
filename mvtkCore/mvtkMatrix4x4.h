#ifndef _mvtkMatrix4x4_h
#define _mvtkMatrix4x4_h

#include "mvtkVector4.h"

class MVTK_COMMON_API mvtkMatrix4x4
{
public:
	float ele[16];

	mvtkMatrix4x4();
	mvtkMatrix4x4(const mvtkMatrix4x4 &m);
	mvtkMatrix4x4(float e0, float e1, float e2, float e3,
			   float e4, float e5, float e6, float e7,
			   float e8, float e9, float e10, float e11,
			   float e12, float e13, float e14, float e15);
	
	mvtkMatrix4x4& operator = (const mvtkMatrix4x4 &m) 
	{
		ele[0] =  m.ele[0]; 
		ele[1] =  m.ele[1]; 
		ele[2] =  m.ele[2]; 
	...
	mvtkMatrix4x4& operator *= (const mvtkMatrix4x4 &);
	mvtkMatrix4x4& operator *= (float);
	mvtkMatrix4x4& operator += (const mvtkMatrix4x4 &);
	mvtkMatrix4x4& operator -= (const mvtkMatrix4x4 &);
	...
	static mvtkMatrix4x4 TranslateMatrix(float tx,float ty,float tz);
	static mvtkMatrix4x4 ScaleMatrix(float sx,float sy,float sz);
	static mvtkMatrix4x4 RotateMatrix(float angle,float x,float y,float z);

};

inline void mvtkMatrix4x4::IdentityMatrix() 
{
...
//----------------------------------------------------------------------------
inline mvtkMatrix4x4 operator * (const mvtkMatrix4x4 &A, const mvtkMatrix4x4 &B) 
{
	mvtkMatrix4x4 Res;
...
//----------------------------------------------------------------------------
inline mvtkMatrix4x4& mvtkMatrix4x4::operator *= (const mvtkMatrix4x4 &B) 
{
	*this=(*this)*B;
	return *this;
}
//----------------------------------------------------------------------------
inline mvtkMatrix4x4 operator * (const mvtkMatrix4x4 &A, float s) 
{
	mvtkMatrix4x4 Res;
	Res.ele[0] = A.ele[0] * s;
	Res.ele[1] = A.ele[1] * s;
...
//----------------------------------------------------------------------------
inline mvtkMatrix4x4 operator * (float s, const mvtkMatrix4x4 &A) 
{
	mvtkMatrix4x4 Res;
	Res.ele[0] = A.ele[0] * s;
	Res.ele[1] = A.ele[1] * s;
...
//----------------------------------------------------------------------------
inline mvtkMatrix4x4& mvtkMatrix4x4::operator *= (float s) 
{
	ele[0] *= s;
	ele[1] *= s;
	ele[2] *= s;
...
//----------------------------------------------------------------------------
inline mvtkMatrix4x4 operator - (const mvtkMatrix4x4 &A)
{
	mvtkMatrix4x4 Res;
...
//----------------------------------------------------------------------------
inline mvtkVector4 operator * (const mvtkVector4& Vec, const mvtkMatrix4x4& Mat) 
{
	mvtkVector4 Res;
...
//----------------------------------------------------------------------------
inline mvtkVector4 operator * (const mvtkMatrix4x4& Mat, const mvtkVector4& Vec) 
{
	mvtkVector4 Res;
